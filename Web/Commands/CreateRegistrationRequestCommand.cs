...
{
    public class CreateRegistrationRequestCommand : Command
    {
        private readonly StoreDbContext _db;
        private GetShoppingCartCommand _getCartCmd;
        private IMailService _mailService;

        public CreateRegistrationRequestCommand(StoreDbContext db, GetShoppingCartCommand getCartCmd, IMailService mailService)
        {
            _db = db;
